...
const VideoTitle = ({title, overview}) => {
    ...
    return (
        <div className='w-[vw] absolute text-white pt-[18%] p-12'>
            <h1 className='text-3xl font-bold'>Movies Trailer Here</h1>
            <p className='w-1/3 mt-4'>OnlyFlix is a sleek, Netflix-inspired web application designed to deliver an immersive streaming experience</p>
